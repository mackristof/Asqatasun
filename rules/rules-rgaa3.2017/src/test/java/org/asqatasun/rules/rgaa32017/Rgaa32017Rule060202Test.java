...
public class Rgaa32017Rule060202Test extends Rgaa32017RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa32017.Rgaa32017Rule060202");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32017.Test.06.02.02-2Failed-01");
        addWebResource("Rgaa32017.Test.06.02.02-2Failed-02");
        addWebResource("Rgaa32017.Test.06.02.02-2Failed-03");
        addWebResource("Rgaa32017.Test.06.02.02-2Failed-04");
        addWebResource("Rgaa32017.Test.06.02.02-3NMI-01");
        addWebResource("Rgaa32017.Test.06.02.02-3NMI-02");
        addWebResource("Rgaa32017.Test.06.02.02-3NMI-03");
        addWebResource("Rgaa32017.Test.06.02.02-3NMI-04");
        addWebResource("Rgaa32017.Test.06.02.02-3NMI-05");
        addWebResource("Rgaa32017.Test.06.02.02-3NMI-06");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-01");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-02");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-03");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-04");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-05");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-06");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-07");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-08");
        addWebResource("Rgaa32017.Test.06.02.02-4NA-09");

        //06.02.01 testcases
        getWebResourceMap().put("Rgaa32017.Test.06.02.01-2Failed-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa32017/Rgaa32017Rule060201/Rgaa32017.Test.06.02.01-2Failed-01.html"));
        getWebResourceMap().put("Rgaa32017.Test.06.02.01-2Failed-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa32017/Rgaa32017Rule060201/Rgaa32017.Test.06.02.01-2Failed-02.html"));
        getWebResourceMap().put("Rgaa32017.Test.06.02.01-2Failed-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa32017/Rgaa32017Rule060201/Rgaa32017.Test.06.02.01-2Failed-03.html"));
        getWebResourceMap().put("Rgaa32017.Test.06.02.01-2Failed-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa32017/Rgaa32017Rule060201/Rgaa32017.Test.06.02.01-2Failed-04.html"));
        getWebResourceMap().put("Rgaa32017.Test.06.02.01-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa32017/Rgaa32017Rule060201/Rgaa32017.Test.06.02.01-3NMI-01.html"));
        getWebResourceMap().put("Rgaa32017.Test.06.02.01-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa32017/Rgaa32017Rule060201/Rgaa32017.Test.06.02.01-3NMI-02.html"));
    ...
    protected void setProcess() {
        ...
        //---------------------------2Failed-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa32017.Test.06.02.02-2Failed-01");
        checkResultIsFailed(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------2Failed-02---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-2Failed-02");
        checkResultIsFailed(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------2Failed-03---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-2Failed-03");
        checkResultIsFailed(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------2Failed-01---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-2Failed-04");
        checkResultIsFailed(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------3NMI-01------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-3NMI-01");
        checkResultIsPreQualified(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------3NMI-02------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-3NMI-02");
        checkResultIsPreQualified(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------3NMI-03------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-3NMI-03");
        checkResultIsPreQualified(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------3NMI-04------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-3NMI-04");
        checkResultIsPreQualified(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------3NMI-05------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-3NMI-05");
        checkResultIsPreQualified(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------3NMI-06------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.06.02.02-3NMI-06");
        checkResultIsPreQualified(processResult,1, 1);
        
        //----------------------------------------------------------------------
        //---------------------------4NA-01-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-01"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-02-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-02"),1);
        
        //----------------------------------------------------------------------
        //---------------------------4NA-03-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-03"),1);
        
        //----------------------------------------------------------------------
        //---------------------------4NA-04-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-04"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-05-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-05"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-06-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-06"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-07-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-07"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-08-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-08"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-09-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.02-4NA-09"));     
        ...
        //---------------------------4NA-6.2.1----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.01-2Failed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.01-2Failed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.01-2Failed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.01-2Failed-04"));
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.01-3NMI-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.06.02.01-3NMI-02"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-06").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-07").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-08").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32017.Test.06.02.02-4NA-09").getValue());
